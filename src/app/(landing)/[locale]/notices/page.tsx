...
export default async function NoticesPage() {
  ...
  return (
    <>
      <section className="w-full min-h-screen bg-zinc-800 flex flex-col pt-23 gap-12 lg:gap-0 lg:pt-0 lg:flex-row text-balance">
        <NavbarPages />
        <article className="pl-4  relative w-full h-[24vh] flex flex-col items-start justify-center text-start md:border-b border-zinc-700 md:w-1/2 md:h-screen lg:pl-6 xl:pl-12 lg:pt-0">
          <h6 className="relative flex text-zinc-300 text-[3.45rem] sm:text-[3.5rem] lg:text-7xl xl:text-[5.7rem] font-medium 3xl:text-9xl">
            {t("title")}
          </h6>
          <p className="relative pr-2 text-sm my-1 text-zinc-400 flex justify-center items-center max-w-100 lg:mt-9 lg:max-w-175 xl:text-lg 3xl:text-xl">
            {t("description")}
          </p>
