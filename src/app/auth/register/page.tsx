...
export default function Register() {
  ...
  return (
    <section className="w-full h-screen px-4 pt-20 text-balance  lg:flex lg:justify-center lg:items-center lg:pt-0 ">
      <div className="relative w-full max-w-110 rounded-lg shadow-md px-3 pt-1 pb-3 md:pt-3 md:p-6 border border-zinc-600 bg-zinc-800/60 lg:bg-linear-to-r ">
        ...
        <h6 className="text-zinc-100 max-w-70 text-2xl xl:mt-1 md:text-3xl 3xl:text-4xl 3xl:max-w-80 3xl:leading-9 3xl:mt-2">
          Registrate para acceder a la App
        </h6>
        <p className="text-zinc-400 mt-3 mb-1.5 text-sm md:text-base 3xl:text-lg 3xl:mt-5 ">
