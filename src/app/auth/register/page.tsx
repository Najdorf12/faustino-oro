        ...
        <div className="relative w-full pt-12 max-w-110 rounded-lg shadow-md p-4 md:p-6 border border-stone-600 bg-zinc-800/60 lg:bg-linear-to-r lg:from-zinc-700 lg:to-stone-500 ">
          ...
          >
            ...
            <button
              ...
              className="w-full bg-white cursor-pointer hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 rounded-md mt-4 flex items-center justify-center gap-2 transition ease-in-out duration-150 disabled:opacity-50"
            >
