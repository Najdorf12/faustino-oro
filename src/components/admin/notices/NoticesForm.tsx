...
export default function NoticesForm({
  ...
  return (
    <section className="w-full  flex items-center justify-center px-4 py-12 lg:pt-18">
    <section className="w-full font-satoshi relative rounded-xl border-zinc-700 shadow-lg  shadow-zinc-900 border-3 overflow-hidden py-6 px-4 space-y-6 md:space-y-7 md:w-140 lg:w-200 xl:w-220 xl:px-8 z-50">
      ...
      >
        ...
        <div className="flex flex-col  ">
          ...
          {loadingImage && <p className="text-zinc-300">Cargando imagen...</p>}
        ...
        <div className="flex gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-sky-800 text-zinc-100 py-2 rounded xl:py-3"
          >
            {loading
              ? "Enviando..."
              : noticeSelected
