...
import imgHomeMobile from "@/assets/images/psmobile04.png";
  ...
  return (
    <>
      <section className=" h-[95vh] md:h-screen w-full relative pb-2.5 lg:pb-1 rounded-b-xl lg:rounded-b-3xl border-b border-zinc-700">
        <div className="absolute inset-0 z-20 bg-zinc-800/20 lg:hidden   rounded-b-xl lg:rounded-b-3xl"></div>
      ...
      `,
        ...
        <article className="relative z-100 w-full h-full flex flex-col items-center justify-end gap-1 md:gap-2  lg:w-1/2 lg:justify-center lg:pt-12">
          <h1 className="bg-linear-to-t from-zinc-300 via-zinc-300 to-zinc-200 lg:bg-linear-to-tl lg:from-zinc-400 lg:via-zinc-300 lg:to-zinc-300 bg-clip-text text-transparent relative z-100 text-[2.9rem] leading-16 sm:text-[3rem] sm:leading-18 font-superlarky text-center md:text-[4rem] lg:leading-32 lg:text-[5.9rem] xl:leading-38 xl:text-[7.2rem] 2xl:leading-44 2xl:text-[8rem] 3xl:leading-50 3xl:text-[9.3rem]">
            Faustino Oro
          </h1>
