...
export default function Tournaments({ data }: TournamentsProps) {
  return (
    <section
      id="tournaments"
      className="w-full min-h-screen flex flex-col gap-12 relative justify-center items-center mt-9 py-10 bg-sky-900 md:h-screen lg:mt-14 lg:gap-16 lg:px-12 2xl:px-16 2xl:gap-20"
    >
      <div className="min-h-screen w-full absolute inset-0 z-50"></div>
      <article className="flex flex-col pl-4 gap-7 lg:flex-row lg:px-9 lg:w-full ">
        ...
        <h6 className="flex items-center text-zinc-300 max-w-130 text-start border-l-2 border-sky-600 text-sm font-medium pl-3 md:pl-6 py-1 md:leading-6 md:text-lg 2xl:text-xl lg:py-2 ">
