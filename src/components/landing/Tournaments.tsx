...
export default function Tournaments({ data }: TournamentsProps) {
  return (
    <section
      id="tournaments"
      className="w-full min-h-screen flex flex-col gap-14 relative justify-center items-center mt-12 py-14 bg-sky-900 md:h-screen lg:mt-14 lg:gap-16 lg:px-12 2xl:px-16 2xl:gap-20"
    >
