...
export default function ButtonBlack() {
  return (
    <Link href={"/notices"}>
      <button className=" shadow-zinc-300 z-100 border hover:scale-105 border-sky-800 duration-300 relative group cursor-pointer text-zinc-200 overflow-hidden h-10 w-56 md:w-62 rounded-md bg-sky-900 p-2 flex justify-between pl-3 items-center font-medium md:text-lg">
        ...
        <p className="z-10">Ir a noticias</p>
        <Image
          src={icon3}
          alt="icon-3"
