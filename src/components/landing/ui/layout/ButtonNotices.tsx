...
export default function ButtonNotices() {
  return (
    <Link href={"/notices"}>
      <button className=" shadow-zinc-300 z-100 border-2 border-white hover:scale-105  duration-300 relative group cursor-pointer text-zinc-200 overflow-hidden h-10 w-56 md:w-62 rounded-md bg-sky-900 p-2 flex justify-between pl-3 items-center font-medium md:text-lg">
