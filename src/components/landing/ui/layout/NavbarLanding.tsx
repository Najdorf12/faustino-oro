...
export default function NavbarLanding() {
  ...
  return (
    <nav className="w-full absolute top-0 z-200 text-zinc-200 lg:text-zinc-320 px-4 pt-2 flex flex-row gap-3 md:gap-10 md:justify-start md:px-6 md:pt-4 lg:px-6 xl:pt-6 xl:px-14 2xl:text-lg ">
