...
export default function NavbarPages() {
  ...
  return (
    <nav className="w-full absolute top-0 z-200 text-zinc-300 lg:text-zinc-320 px-4 pt-2 flex flex-row gap-3 md:gap-10 md:justify-start md:px-6 md:pt-4 lg:px-6 xl:pt-6 xl:px-14 2xl:text-lg ">
      ...
      <ul className="flex items-center justify-end gap-3 md:font-medium text-sm md:flex-row md:justify-start font-medium lg:gap-6 xl:text-lg 3xl:text-xl">
        <li>
          <Link
            href="/"
      ...
      <div className="absolute right-2 top-12 flex items-center md:top-6 lg:right-12 xl:top-7.5 xl:right-12 ">
        <LanguageSwitcher />
      </div>
    </nav>
  );
