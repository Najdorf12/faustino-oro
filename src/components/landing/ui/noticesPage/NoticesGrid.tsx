  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto 3xl:max-w-350">
        {/* Título */}
        <h6 className="text-zinc-200 text-[2rem] sm:text-4xl lg:text-6xl border-l-3 border-sky-700 py-2 pl-4 lg:pl-6 mb-10 lg:mb-12 3xl:text-7xl">
          Todas las noticias
        </h6>
        ...
        <div className="flex flex-wrap gap-2 mb-10 lg:mb-14">
          {CATEGORIES.map((cat) => (
            <button
              ...
              className={`
                px-4 py-1.5 rounded-sm text-sm font-medium border transition-all duration-300 cursor-pointer
                ${
                  activeCategory === cat
            ...
            {paginated.map((notice: any) => (
              ...
              >
                ...
                <div className="self-start mb-2 ml-3 bg-zinc-700/70 border border-sky-500 cursor-pointer z-100 w-48 rounded-lg h-8.5 relative text-zinc-100 md:font-medium flex items-center pl-3 group lg:w-50 lg:mb-3 lg:h-9.5">
                  ...
                  <div className="bg-sky-600 cursor-pointer rounded-lg h-[33px] w-8 grid place-items-center absolute right-0 top-0 group-hover:w-full z-10 duration-500 lg:w-9 lg:h-9">
                    <svg
